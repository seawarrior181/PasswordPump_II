/*               ___                              _ ___
  ...
  * After 5 minutes of inactivity clear the screen if the logout timeout is set
  ...
  available here: https://github.com/seawarrior181/PasswordPump_II/blob/master/v2_0_9/PassPumpGUI/PassPumpGUI_v2_0.py
...
#define SSD1306_I2C_ADDR          0x3C                                          // Slave 128x64 OLED I2C address
#define SH1107_I2C_ADDR           0x3C                                          // Slave 128x128 OLED I2C address
...
#endif
#ifdef __SH1107__
  //Adafruit_SH1107 oled = Adafruit_SH1107(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET, 1000000, 100000);
  DisplaySH1107_128x64_I2C oled(-1);                                         // or (-1,{busId, addr, scl, sda, frequency}). This line is suitable for most platforms by default
#endif
...
void setup() {                                                                  // runs first when the device is powered on
  ...
  pinMode(joystick1,  INPUT_PULLUP);
  pinMode(joystick2,  INPUT_PULLUP);
  pinMode(joystick3,  INPUT_PULLUP);
...
#endif
#ifdef __SH1107__
//  oled.begin(SH1107_I2C_ADDR, true);                                            // Address 0x3C default
//  oled.clearDisplay();
//  oled.setTextSize(1);                                                          // Normal 1:1 pixel scale
//  oled.setTextColor(SH110X_WHITE);                                              // Draw white text
//  oled.setCursor(0, 0);                                                         // Start at top-left corner
//  oled.cp437(true);                                                             // Use full 256 char 'Code Page 437' font
//  //oled.displayRemap(1);  // won't compile
...
//  oled.display();
    ...
    oled.clear();
    oled.printFixed(0,  8, "Normal text", STYLE_NORMAL);
    oled.printFixed(0, 16, "Bold text", STYLE_BOLD);
    oled.printFixed(0, 24, "Italic text", STYLE_ITALIC);
    oled.invertColors();
    oled.printFixed(0, 32, "Inverted bold", STYLE_BOLD);
    oled.invertColors();
    lcd_delay(3000);
    oled.clear();
#endif
...
void DisplayBuffer() {
  ...
  oled.setFixedFont(ssd1306xled_font6x8);
  oled.clear();
  oled.printFixed(0,  8,  line1DispBuff, STYLE_NORMAL);
  oled.printFixed(0,  16, line2DispBuff, STYLE_NORMAL);
  oled.printFixed(0,  24, line3DispBuff, STYLE_NORMAL);
#endif
}
...
#endif
#ifdef __SH1107__
  oled.printFixed(0,  32,  line4DispBuff, STYLE_NORMAL);
#endif
}
...
#ifdef __SH1107__
  char charToPrint[2];
  oled.printFixed(0, 24. line3DispBuff);
  charToPrint[0] = charToShow;
  charToPrint[1] = NULL_TERM;
  oled.printFixed((NO_LED_LIB_CHAR_WIDTH_PIX * pos) + FIXED_CHAR_SPACING,LINE_3_POS,  24, charToPrint, STYLE_NORMAL);
#endif
}
