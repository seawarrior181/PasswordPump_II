...
# Change Log
unreleased v2.0.5
 Note: please use v2.0.4 unless you're adventurous.  There are apparently problems when certain fonts are selected.  I need to identify the problematic fonts and remove them.
